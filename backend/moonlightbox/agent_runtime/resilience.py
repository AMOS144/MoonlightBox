...
def classify_failure(error):
    ...
    categories = {
        ...
        "quota_exhausted": ("quota", False, "模型套餐用量已用完，须充值、升级套餐或等待下一计费窗口"),
        "billing_unavailable": ("quota", False, "模型账户余额不足，请充值后重试"),
        "provider_input_rejected": ("provider_rejection", False, "模型服务判定输入内容涉敏"),
        "provider_output_rejected": ("provider_rejection", False, "模型服务判定输出内容涉敏"),
